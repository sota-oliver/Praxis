<template>
            ...
            <div class="row">
                <div class="col">
                    <ul class="progressbar">
                        <li :class="{active : currentStep >= 1}" >Job Description</li>
                        <li :class="{active : currentStep >= 2}" >Skills</li>
                        <li :class="{active : currentStep >= 3}" >Study</li>
                    </ul>
                </div>
            </div>
            <div class="row" >
                <div class="col">
                    <CompanyStep1 v-if="this.currentStep === 1"/>
                    <CompanyStep2 v-else-if="this.currentStep === 2"/>
                    <CompanyStep3 v-else-if="this.currentStep === 3"/>
                </div>
            </div>
    ...
    <div class="modal-content">
        ...
        <p>Are you sure you want to discard current Ad</p>
        <p>Confirm to quit</p>
        </div>
        <div class="modal-footer" >
        <router-link style="text-decoration: none;" to="/company">
...
import CompanyStep3 from '@/components/CompanyStep3.vue'
    ...
    methods:{
          nextStep(){
            if(this.currentStep < 3){
                ...
                this.$router.push({path: '/preview-add'});
            }    
        },
